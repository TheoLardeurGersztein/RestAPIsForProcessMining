...
public abstract class MiningParametersAbstract implements MiningParameters {
	...
	protected XEventClassifier classifier = defaultClassifier;
	protected float noiseThreshold = defaultNoiseThreshold;
	protected boolean isDebug = defaultIsDebug;
	protected boolean isUseMultithreading = defaultIsUseMultiThreading;
